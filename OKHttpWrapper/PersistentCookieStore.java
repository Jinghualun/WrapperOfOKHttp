...
/**
 * A persistent cookie store which implements the {@link CookieStore} interface.
 ...
 * client.setCookieHandler(new CookieManager(new PersistentCookieStore(getApplicationContext()),
